...
RUN apt-get install -y --no-install-recommends apt-utils apt psmisc python perl liberror-perl libllvm3.9 libapache2-mod-php7.0 php7.0-fpm php7.0-cgi php7.0-common python3.5 libpython3-stdlib wget sudo php7.0 python3 python3-setuptools ca-certificates curl fakeroot gconf2 gconf-service git gvfs-bin libasound2 libcap2 libgconf-2-4 libgtk2.0-0 libgtk-3-0 libnotify4 libnss3 libxkbfile1 libxss1 libxtst6 libgl1-mesa-glx libgl1-mesa-dri xdg-utils libcanberra-gtk-module
